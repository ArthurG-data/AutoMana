...
-- ===========================================================================
-- Migration 40: MTGStock link fixes
-- Seeds pricing.mtgstock_art_set_map (43 rows) and
-- pricing.mtgstock_token_set_map (186 rows), then refreshes
-- load_staging_prices_batched and resolve_price_rejects in place.
-- ===========================================================================

-- ---------------------------------------------------------------------------
-- 1) Art set map seeds (43 rows)
-- ---------------------------------------------------------------------------
INSERT INTO pricing.mtgstock_art_set_map (mtgstocks_set_code, scryfall_set_code) VALUES
    ('AAINR', 'ainr'), ('ADFT',  'adft'), ('AEOE',  'aeoe'), ('AFIN',  'afin'),
    ('AATDM', 'aatdm'), ('ASLD',  'asld'), ('APRE',  'apre'), ('AMAT',  'amat'),
    ('AACR',  'aacr'), ('AAFR',  'aafr'), ('ABLB',  'ablb'), ('ABRO',  'abro'),
    ('ACLB',  'aclb'), ('ACMM',  'acmm'), ('ADMU',  'admu'), ('ADSK',  'adsk'),
    ('AECL',  'aecl'), ('AFDN',  'afdn'), ('AJMP',  'ajmp'), ('AKHM',  'akhm'),
    ('ALCI',  'alci'), ('ALTC',  'altc'), ('ALTR',  'altr'), ('AMH1',  'amh1'),
    ('AMH2',  'amh2'), ('AMH3',  'amh3'), ('AMID',  'amid'), ('AMKM',  'amkm'),
    ('AMOM',  'amom'), ('ANEO',  'aneo'), ('AONE',  'aone'), ('AOTJ',  'aotj'),
    ('ASNC',  'asnc'), ('ASOS',  'asos'), ('ASPM',  'aspm'), ('ASTX',  'astx'),
    ('ATDM',  'atdm'), ('ATLA',  'atla'), ('ATLE',  'atle'), ('ATMT',  'atmt'),
    ('AVOW',  'avow'), ('AWOE',  'awoe'), ('AZNR',  'aznr')
ON CONFLICT (mtgstocks_set_code) DO NOTHING;

-- ---------------------------------------------------------------------------
-- 2) Token set map seeds (186 rows)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 3) Refresh load_staging_prices_batched (verbatim from 06_prices.sql)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 4) Refresh resolve_price_rejects (verbatim from 06_prices.sql)
-- ---------------------------------------------------------------------------
