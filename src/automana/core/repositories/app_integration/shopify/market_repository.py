...
from automana.core.models.shopify import Market as Market_Model
from automana.core.repositories.app_integration.shopify import market_queries as queries
