from automana.core.repositories.abstract_repositories.AbstractAPIRepository import  BaseApiClient                    #abstract_re . Abstract APIRepository import ApiRepository
from automana.core.exceptions.repository_layer_exceptions.ebay_integration import ebay_api_exception
from typing import Dict, Any, Optional, List
from httpx import AsyncClient, HTTPStatusError
from automana.core.schemas.ebay import EbayXmlBuilder
from automana.core.models.ebay.listings import ItemModel
from automana.core.models.ebay.trading_api import HeaderApi
