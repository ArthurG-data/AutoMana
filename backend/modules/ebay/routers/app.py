...
@ebay_app_router.post('/{app_id}/scopes', description='add a scope to an app')
...
@ebay_app_router.post('/', description='add an app to the database')
...
@ebay_app_router.post('/{app_id}/{ebay_id}')
