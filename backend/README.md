...
**Problem**: I want an AI agent that can automaticlly list TCG on eBay
**Users**: Me, friends
**Success**: I can have my collection recorded on the platform, listing created and updated based on current pricing and predefine strategies, daily.

## Milestones

M1 – Data Collection: Card Catalogue

Goal: Build a complete, queryable catalog of MTG cards.

Epics

M1E1 — Scryfall Ingestion

M1E2 — Database Schema for Card Catalog

M1E3 — Data Ingestion Pipeline (ETL)

M2 – Core Backend

Goal: Stand up a secure backend with catalog search & user auth.

Epics

M2E1 — Catalog Search API

M2E2 — User Authentication & Authorization

M2E3 — Dependency Injection / Authentication Middleware

M3 – Pricing Data

Goal: Collect pricing signals, store historical prices, and enable analytics.

Epics

M3E1 — Pricing Data Ingestion (2+ sources, Shopify-style model)

M3E2 — Database Schema for Pricing (TimescaleDB)

M3E3 — ETL Pipeline for Capturing Price Changes

M4 – eBay API Integration

Goal: Enable reading and creating listings on eBay.

Epics

M4E1 — eBay Sandbox Authentication

M4E2 — Create Listing via API

M4E3 — Search Existing Items (Browse API Integration)

M5 – Automation & AI

Goal: Make the system autonomous: fetch data, price cards, and create listings.

Epics

M5E1 — Scheduled Tasks for Catalog & Pricing Ingestion

M5E2 — AI Model for Sold-Item Pricing Analysis

M5E3 — Price Suggestion / Valuation Model

M5E4 — Automated Listing Generation Workflow

M6 – Frontend

Goal: UI for collection management and listing status dashboards.

Epics

M6E1 — Collection Browsing UI

M6E2 — Sales Status Dashboard

M6E3 — Admin Tools for Automation/Debugging
